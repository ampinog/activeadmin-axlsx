  ...
  module Axlsx
    module ResourceControllerExtension
      def self.included(base)
        ...
        base.send :alias_method, :per_page_with_xlsx, :xlsx
        base.send :alias_method, :xlsx, :per_page_without_xlsx
        #base.send :alias_method_chain, :index, :xlsx
        base.send :alias_method, :index_with_xlsx, :xlsx
        base.send :alias_method, :xlsx, :index_without_xlsx
